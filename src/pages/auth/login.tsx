    ...
    <div className="w-full h-screen font-poppins background-login flex flex-col justify-between">
      <div className="flex justify-center h-full">
        <div className="flex flex-col justify-center gap-20 px-6 md:px-20">
          <p className="text-2xl md:text-4xl lg:text-4xl xl:text-6xl font-bold">
            Smart solution <br /> for your brand are here
          </p>
          <div className="flex flex-col gap-2 w-full">
            <p className="text-xl xl:text-4xl font-semibold">Join us now</p>
            ...
            <div className="flex items-center justify-between">
              <p className="text-xs md:text-base font-medium pr-3 md:pr-10 xl:w-[500px]">
